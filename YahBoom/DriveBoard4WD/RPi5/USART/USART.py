...
UPLOAD_DATA = 1  # 0:不接受数据 1:接收总的编码器数据 2:接收实时的编码器 3:接收电机当前速度 mm/s
...
ser = serial.Serial(
    port='/dev/ttyUSB0',
    # 根据实际情况修改为你的串口设备路径  Modify it to your serial port device path according to the actual situation
